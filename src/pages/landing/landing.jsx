    ...
    return (
        <>
            ...
            <div className="cards gap-6 flex flex-wrap justify-center items-center  "  data-aos="fade-up" data-aos-duration="1000">
                <Card prop={{header:"Identify abuse", content:"Identifying psychological abuse in women involves recognizing manipulation, control, gaslighting, isolation, threats, and undermining of confidence and autonomy." , img:"../../../public/indentify-abuse.jpg"}} />
